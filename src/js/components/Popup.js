...
class Popup {
  ...
  showResultPopup(result, type) {
    ...
    <div class="popup__inner">
      ...
      <div class="popup-title popup-title__result">Отлично!</div>

      <div class="popup-result__score">${result}/10</div>

      <div class="popup-result__buttons">
        <button data-route="main" class="btn popup__btn">Домой</button>
        <button data-route="categories${type}" class="btn popup__btn popup__btn-continue">Дальше</button>
      </div>
    </div>`;
